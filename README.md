...
رهجو یک CRM و فضای عملیاتی برای تیم‌هایی است که مشتری، فروش، پرونده و اجرای کار را در یک جریان قابل پیگیری نگه می‌دارند. دسته‌بندی محصول عمداً به یک صنعت محدود نیست؛ فروش B2B، بازرگانی، خدمات، تیم‌های پروژه‌ای، آموزش و مشاوره و کسب‌وکارهای در حال رشد می‌توانند از همان هستهٔ مشترک استفاده کنند.
...
- سایت عمومی canonical: **خانه، محصول، شروع**؛ ورود به محیط کار یک utility action جداست.
- مسیرهای عمومی legacy فقط برای سازگاری باقی می‌مانند و نباید دوباره به navigation یا روایت اصلی تبدیل شوند.
...
نمایش چند screenshot بزرگ پشت سر هم، feature-gridهای پرکننده و صفحه‌های عمومی بدون ارزش مستقل خلاف baseline فعلی W14 هستند.
